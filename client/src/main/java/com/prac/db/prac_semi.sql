...
CREATE TABLE CHATMESSAGES(
	...
	FROMID VARCHAR2(1000) NOT NULL REFERENCES USERS(USERID),
	TOID VARCHAR2(1000) NOT NULL REFERENCES USERS(USERID),
	MESSAGE VARCHAR2(4000) NOT NULL,
	CHATREAD VARCHAR2(10) NOT NULL CHECK(CHATREAD IN ('Y', 'N')),
	SENDDATE VARCHAR2(1000) NOT NULL
);

SELECT SEQ, ROOMID, FROMID, TOID, MESSAGE, CHATREAD, SENDDATE FROM CHATMESSAGES ORDER BY SENDDATE ASC;

DELETE FROM CHATMESSAGES;

SELECT COUNT(CHATREAD) FROM CHATMESSAGES
WHERE FROMID='mentor1' AND TOID = 'jane' and CHATREAD = 'N';
